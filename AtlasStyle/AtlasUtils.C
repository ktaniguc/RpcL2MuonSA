...
void myBoxTextwoLine(Double_t x, Double_t y,Double_t boxsize,Int_t mcolor,const char *text) 
{
...
void myLineText(Double_t x,Double_t y,Int_t color,Int_t lstyle, const char *text) 
{
  Double_t tsize=0.06;
  ...
  line->SetLineWidth(4);
  line->DrawLineNDC(x-0.05,y,x-0.01,y);
